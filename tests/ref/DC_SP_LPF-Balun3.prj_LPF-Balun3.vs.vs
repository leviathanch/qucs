(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="LPF-Balun3.dat", qucs_DataDisplay="LPF-Balun3.dpl", qucs_SimOpenDpl=1, qucs_Script="LPF-Balun3.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module LPF-Balun3();
    ...
    wire n_960_200;
    wire n_990_100;
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=40, S0_y1=110, S0_x2=100, S0_y2=110 *) Pac #(.Num(1),.Z(100 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P1 ( n_40_110, n_100_110 );
    ...
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=960, S0_y1=100, S0_x2=1020, S0_y2=100 *) Pac #(.Num(2),.Z(100 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P2 ( n_960_100, n_1020_100 );
    ...
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=230, S0_y1=80, S0_x2=170, S0_y2=40, S0_x3=170, S0_y3=-20, S0_x4=230, S0_y4=-60, S0_x5=230, S0_y5=0, S0_x6=230, S0_y6=20 *) sTr #(.T1(0.5),.T2(0.5)) Tr5 ( n_230_80, n_170_40, n_170_m20, n_230_m60, n_230_0, n_230_20 );
    ...
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=300, S0_y1=150, S0_x2=360, S0_y2=150 *) Vdc #(.U(1V)) V1 ( n_300_150, n_360_150 );
