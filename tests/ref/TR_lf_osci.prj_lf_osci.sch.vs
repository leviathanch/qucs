module lf_osci();
    ...
    (* S0_x1=310, S0_y1=210, S0_x2=370, S0_y2=210 *) R #(.R(30 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_310_210, n_370_210 );
    (* S0_x1=190, S0_y1=210, S0_x2=250, S0_y2=210 *) R #(.R(30 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_190_210, n_250_210 );
    (* S0_x1=70, S0_y1=210, S0_x2=130, S0_y2=210 *) R #(.R(30 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_70_210, n_130_210 );
    (* S0_x1=160, S0_y1=320, S0_x2=160, S0_y2=260 *) C #(.C(30 nF),.V()) C1 ( n_160_320, n_160_260 );
    (* S0_x1=280, S0_y1=320, S0_x2=280, S0_y2=260 *) C #(.C(30 nF),.V()) C2 ( n_280_320, n_280_260 );
    (* S0_x1=400, S0_y1=320, S0_x2=400, S0_y2=260 *) C #(.C(30 nF),.V()) C3 ( n_400_320, n_400_260 );
    (* S0_x1=460, S0_y1=400 *) \.TR  #(.Type(lin),.Start(0),.Stop(20 ms),.Points(500),.IntegrationMethod(Trapezoidal),.Order(2),.InitialStep(1 ns),.MinStep(1e-16),.MaxIter(150),.reltol(0.001),.abstol(1 pA),.vntol(1 uV),.Temp(26.85),.LTEreltol(1e-3),.LTEabstol(1e-6),.LTEfactor(1),.Solver(CroutLU),.relaxTSR(no),.initialDC(yes),.MaxStep(0)) TR1 (  );
    (* S0_x1=500, S0_y1=130, S0_x2=500, S0_y2=70 *) R #(.R(10 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_500_130, n_500_70 );
