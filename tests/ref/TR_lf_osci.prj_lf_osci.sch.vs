(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="lf_osci.dat", qucs_DataDisplay="lf_osci.dpl", qucs_SimOpenDpl=1, qucs_Script="lf_osci.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module lf_osci();
    ...
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=160, S0_y1=320, S0_x2=160, S0_y2=260 *) C #(.C(30 nF),.V(),.Symbol(neutral)) C1 ( n_160_320, n_160_260 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=280, S0_y1=320, S0_x2=280, S0_y2=260 *) C #(.C(30 nF),.V(),.Symbol(neutral)) C2 ( n_280_320, n_280_260 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=400, S0_y1=320, S0_x2=400, S0_y2=260 *) C #(.C(30 nF),.V(),.Symbol(neutral)) C3 ( n_400_320, n_400_260 );
    (* qucs_mirrored=0, qucs_rotated=0,  *) \.TR  #(.Type(lin),.Start(0),.Stop(20 ms),.Points(500),.IntegrationMethod(Trapezoidal),.Order(2),.InitialStep(1 ns),.MinStep(1e-16),.MaxIter(150),.reltol(0.001),.abstol(1 pA),.vntol(1 uV),.Temp(26.85),.LTEreltol(1e-3),.LTEabstol(1e-6),.LTEfactor(1),.Solver(CroutLU),.relaxTSR(no),.initialDC(yes),.MaxStep(0)) TR1 (  );
