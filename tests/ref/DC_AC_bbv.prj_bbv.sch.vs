...
module bbv();
    ...
    wire n_650_220;
    wire n_650_250;
    (* S0_x1=130, S0_y1=370, S0_x2=130, S0_y2=310 *) R #(.R(12),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RE1 ( n_130_370, n_130_310 );
    (* S0_x1=130, S0_y1=150, S0_x2=130, S0_y2=90 *) R #(.R(650),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_130_150, n_130_90 );
    ...
    (* S0_x1=220, S0_y1=280, S0_x2=160, S0_y2=280 *) R #(.R(140),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RF1 ( n_220_280, n_160_280 );
    ...
    (* S0_x1=300, S0_y1=410, S0_x2=240, S0_y2=410 *) R #(.R(200),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RF2 ( n_300_410, n_240_410 );
    ...
    (* S0_x1=350, S0_y1=270, S0_x2=350, S0_y2=210 *) R #(.R(140),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_350_270, n_350_210 );
    ...
    (* S0_x1=440, S0_y1=340, S0_x2=440, S0_y2=280 *) R #(.R(12),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RE2 ( n_440_340, n_440_280 );
    ...
    (* S0_x1=440, S0_y1=110, S0_x2=440, S0_y2=50 *) R #(.R(225),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_440_110, n_440_50 );
    (* S0_x1=440, S0_y1=420 *) GND #() \*  ( n_440_420 );
    (* S0_x1=530, S0_y1=130, S0_x2=470, S0_y2=130 *) R #(.R(10),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R0 ( n_530_130, n_470_130 );
    ...
    (* S0_x1=650, S0_y1=250, S0_x2=650, S0_y2=190 *) R #(.R(1k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) RL ( n_650_250, n_650_190 );
