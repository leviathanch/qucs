(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="timer_amp.dat", qucs_DataDisplay="timer_amp.dpl", qucs_SimOpenDpl=1, qucs_Script="timer_amp.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module timer_amp(.P_vout(n_365_265), .Pamp_P(n_210_265), .Pamp_N(n_210_325), .P_vout(n_365_265), .Pamp_P(n_210_265), .Pamp_N(n_210_325));
    inout n_365_265;
    inout n_210_265;
    inout n_210_325;
    inout n_365_265;
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=365, S0_y1=265 *) Port #(.Num(3),.Type(analog)) P_vout ( n_365_265 );
