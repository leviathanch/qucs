...
<Paintings>
  <Text 0 0 14 #000000 0 "equivalent circuit">
  <Text 0 0 14 #000000 0 "Gyrator">
  <Text 0 0 14 #000000 0 "L = R1 * R2 * C">
  <Text 0 0 12 #000000 0 "As can be seen: With the use ofnan OpAmps, a capacitor cannrebuild a very large inductor.">
</Paintings>
