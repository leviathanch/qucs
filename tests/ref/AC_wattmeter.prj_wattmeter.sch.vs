module wattmeter();
    ...
    (* S0_x1=306, S0_y1=287, S0_x2=306, S0_y2=227 *) R #(.R(15 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_306_287, n_306_227 );
    (* S0_x1=406, S0_y1=287, S0_x2=406, S0_y2=227 *) R #(.R(6 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_406_287, n_406_227 );
    (* S0_x1=516, S0_y1=287, S0_x2=516, S0_y2=227 *) R #(.R(8 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_516_287, n_516_227 );
    (* S0_x1=516, S0_y1=407, S0_x2=516, S0_y2=347 *) C #(.C(177 uF),.V()) C1 ( n_516_407, n_516_347 );
