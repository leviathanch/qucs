...
<Wires>
  ...
  <40 120 40 190 "" 0 0 0 "">
  <40 120 280 120 "" 0 0 0 "">
</Wires>
<Diagrams>
</Diagrams>
<Paintings>
  <Text 320 350 12 #000000 0 "50Hz notch filter:nbuilt by use of extremly high Q gyrator,nOpAmps fake a 10.1Henry+0.5mOhm coilnthat forms resonance circuit with C2">
  <Text 320 420 12 #000000 0 "OpAmp gyrator fakes:ninductance = C1*R1*R2*R4/R3nresistance = 0.5*R2*R4/R3/OpAmpGain">
</Paintings>
