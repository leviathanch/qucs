...
<Paintings>
  <Text 350 0 12 #000000 0 "50Hz notch filter:nbuilt by use of extremly high Q gyrator,nOpAmps fake a 10.1Henry+0.5mOhm coilnthat forms resonance circuit with C2">
  <Text 420 0 12 #000000 0 "OpAmp gyrator fakes:ninductance = C1*R1*R2*R4/R3nresistance = 0.5*R2*R4/R3/OpAmpGain">
</Paintings>
