module lpf0();
    ...
    (* S0_x1=170, S0_y1=300, S0_x2=170, S0_y2=240 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_170_300, n_170_240 );
    (* S0_x1=230, S0_y1=360, S0_x2=230, S0_y2=300 *) C #(.C(4.182 pF),.V()) C3 ( n_230_360, n_230_300 );
    (* S0_x1=170, S0_y1=190, S0_x2=170, S0_y2=130 *) C #(.C(2.091 pF),.V()) C1 ( n_170_190, n_170_130 );
    (* S0_x1=290, S0_y1=190, S0_x2=290, S0_y2=130 *) C #(.C(2.091 pF),.V()) C2 ( n_290_190, n_290_130 );
    (* S0_x1=330, S0_y1=190, S0_x2=390, S0_y2=190 *) L #(.L(5.228 nH),.I()) L3 ( n_330_190, n_390_190 );
    (* S0_x1=290, S0_y1=300, S0_x2=290, S0_y2=240 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_290_300, n_290_240 );
    ...
    (* S0_x1=680, S0_y1=300, S0_x2=680, S0_y2=240 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_680_300, n_680_240 );
    (* S0_x1=800, S0_y1=300, S0_x2=800, S0_y2=240 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_800_300, n_800_240 );
    ...
    (* S0_x1=300, S0_y1=380 *) Eqn #(.dBS21(dB(S[2,1])),.dBS11(dB(S[1,1]))) Eqn1 (  );
