module lpf0();
    ...
    wire n_930_150;
    wire n_930_240;
    (* S0_x1=70, S0_y1=190S0_x2=130, S0_y2=190 *) L #() L2 ( n_70_190, n_130_190 );
    (* S0_x1=170, S0_y1=300S0_x2=170, S0_y2=240 *) R #() R1 ( n_170_300, n_170_240 );
    (* S0_x1=230, S0_y1=360S0_x2=230, S0_y2=300 *) C #() C3 ( n_230_360, n_230_300 );
    (* S0_x1=170, S0_y1=190S0_x2=170, S0_y2=130 *) C #() C1 ( n_170_190, n_170_130 );
    (* S0_x1=290, S0_y1=190S0_x2=290, S0_y2=130 *) C #() C2 ( n_290_190, n_290_130 );
    (* S0_x1=330, S0_y1=190S0_x2=390, S0_y2=190 *) L #() L3 ( n_330_190, n_390_190 );
    (* S0_x1=290, S0_y1=300S0_x2=290, S0_y2=240 *) R #() R2 ( n_290_300, n_290_240 );
    (* S0_x1=230, S0_y1=360 *) GND #() \*  ( n_230_360 );
    (* S0_x1=420, S0_y1=90S0_x2=420, S0_y2=150 *) Pac #() P2 ( n_420_90, n_420_150 );
    (* S0_x1=420, S0_y1=150 *) GND #() \*  ( n_420_150 );
    (* S0_x1=40, S0_y1=90S0_x2=40, S0_y2=150 *) Pac #() P1 ( n_40_90, n_40_150 );
    (* S0_x1=40, S0_y1=150 *) GND #() \*  ( n_40_150 );
    (* S0_x1=70, S0_y1=190 *) GND #() \*  ( n_70_190 );
    (* S0_x1=390, S0_y1=190 *) GND #() \*  ( n_390_190 );
    (*  *) \.SP  #() SP1 (  );
    (* S0_x1=200, S0_y1=90S0_x2=260, S0_y2=90 *) L #() L1 ( n_200_90, n_260_90 );
    (* S0_x1=680, S0_y1=300S0_x2=680, S0_y2=240 *) R #() R3 ( n_680_300, n_680_240 );
    (* S0_x1=800, S0_y1=300S0_x2=800, S0_y2=240 *) R #() R4 ( n_800_300, n_800_240 );
    (* S0_x1=930, S0_y1=150 *) GND #() \*  ( n_930_150 );
    (* S0_x1=550, S0_y1=150 *) GND #() \*  ( n_550_150 );
    (* S0_x1=550, S0_y1=240 *) GND #() \*  ( n_550_240 );
    (* S0_x1=570, S0_y1=240S0_x2=630, S0_y2=240 *) TLIN #() Line4 ( n_570_240, n_630_240 );
    (* S0_x1=930, S0_y1=240 *) GND #() \*  ( n_930_240 );
    (* S0_x1=850, S0_y1=240S0_x2=910, S0_y2=240 *) TLIN #() Line5 ( n_850_240, n_910_240 );
    (* S0_x1=740, S0_y1=320S0_x2=740, S0_y2=380 *) TLIN #() Line6 ( n_740_320, n_740_380 );
    (* S0_x1=550, S0_y1=90S0_x2=550, S0_y2=150 *) Pac #() P3 ( n_550_90, n_550_150 );
    (* S0_x1=930, S0_y1=90S0_x2=930, S0_y2=150 *) Pac #() P4 ( n_930_90, n_930_150 );
    (*  *) Eqn #() Eqn1 (  );
    (* S0_x1=750, S0_y1=30S0_x2=750, S0_y2=90S0_x3=730, S0_y3=90S0_x4=730, S0_y4=30 *) TLIN4P #() Line1 ( n_750_30, n_750_90, n_730_90, n_730_30 );
    (* S0_x1=860, S0_y1=170S0_x2=800, S0_y2=170S0_x3=800, S0_y3=150S0_x4=860, S0_y4=150 *) TLIN4P #() Line3 ( n_860_170, n_800_170, n_800_150, n_860_150 );
    (* S0_x1=680, S0_y1=170S0_x2=620, S0_y2=170S0_x3=620, S0_y3=150S0_x4=680, S0_y4=150 *) TLIN4P #() Line2 ( n_680_170, n_620_170, n_620_150, n_680_150 );
