(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="lf_osci.dat", qucs_DataDisplay="lf_osci.dpl", qucs_SimOpenDpl=1, qucs_Script="lf_osci.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module lf_osci();
    ...
    (* S0_x1=80, S0_y1=380, S0_x2=369, S0_y2=73, qucs_type="Text", S0_text="The feedback of this oscillator is realized by threenRC networks, which create 60� phase shift each atnoscillating frequency.n=> freq = sqrt(6) / (2*pi*R*C)" *) S0_text #() S0_text1;
endmodule
