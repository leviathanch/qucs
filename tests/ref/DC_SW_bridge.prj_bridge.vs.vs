(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="bridge.dat", qucs_DataDisplay="bridge.dpl", qucs_SimOpenDpl=1, qucs_Script="bridge.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module bridge();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=460, S0_y1=160, S0_x2=520, S0_y2=160 *) R #(.R(500 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_460_160, n_520_160 );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=460, S0_y1=300, S0_x2=520, S0_y2=300 *) R #(.R(Rmeasure),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R5 ( n_460_300, n_520_300 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=180, S0_y1=300 *) GND #() \\*  ( n_180_300 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=280, S0_y1=160, S0_x2=340, S0_y2=160 *) R #(.R(Rbranch),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_280_160, n_340_160 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=280, S0_y1=300, S0_x2=340, S0_y2=300 *) R #(.R(Rbranch),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_280_300, n_340_300 );
