module gain();
    ...
    wire n_40_260;
    wire n_40_270;
(* S0_x1=40, S0_y1=200, S0_x2=40, S0_y2=260 *) Vac V4(n_40_200,n_40_260);(* S0_x1=40, S0_y1=270 *) GND *(n_40_270);(* S0_x1=290, S0_y1=310, S0_x2=230, S0_y2=310 *) R R2(n_290_310,n_230_310);(* S0_x1=100, S0_y1=310 *) GND *(n_100_310);(* S0_x1=360, S0_y1=300, S0_x2=360, S0_y2=240 *) R R1(n_360_300,n_360_240);(* S0_x1=360, S0_y1=300 *) GND *(n_360_300);(* S0_x1=130, S0_y1=150 *) GND *(n_130_150);(* S0_x1=130, S0_y1=90, S0_x2=130, S0_y2=150 *) Vdc V3(n_130_90,n_130_150);(* S0_x1=210, S0_y1=400 *) GND *(n_210_400);(* S0_x1=210, S0_y1=340, S0_x2=210, S0_y2=400 *) Vdc V6(n_210_340,n_210_400);(*  *) .AC AC1();(*  *) .DC DC1();(*  *) Eqn Eqn1();(*  *) Sub OPV1();(* S0_x1=160, S0_y1=310, S0_x2=100, S0_y2=310 *) R R3(n_160_310,n_100_310);    (* S0_x1=260, S0_y1=220, S0_x2=290, S0_y2=220 *) net net0(n_260_220, n_290_220);
