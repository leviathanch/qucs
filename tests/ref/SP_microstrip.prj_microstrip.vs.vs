(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="microstrip.dat", qucs_DataDisplay="microstrip.dpl", qucs_SimOpenDpl=1, qucs_Script="microstrip.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module microstrip();
    ...
    wire n_550_200;
    wire n_580_140;
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=340, S0_y1=320, S0_x2=400, S0_y2=320 *) Pac #(.Num(3),.Z(50 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P3 ( n_340_320, n_400_320 );
    ...
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=550, S0_y1=140, S0_x2=610, S0_y2=140 *) Pac #(.Num(2),.Z(50 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P2 ( n_550_140, n_610_140 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=550, S0_y1=200 *) GND #() \\*  ( n_550_200 );
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=100, S0_y1=140, S0_x2=160, S0_y2=140 *) Pac #(.Num(1),.Z(50 Ohm),.P(0 dBm),.f(1 GHz),.Temp(26.85)) P1 ( n_100_140, n_160_140 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=100, S0_y1=200 *) GND #() \\*  ( n_100_200 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=260, S0_y1=290, S0_x2=320, S0_y2=290 *) C #(.C(30 pF),.V(),.Symbol(neutral)) C1 ( n_260_290, n_320_290 );
