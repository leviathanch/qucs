(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="selective_amp.dat", qucs_DataDisplay="selective_amp.dpl", qucs_SimOpenDpl=1, qucs_Script="selective_amp.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module selective_amp();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=120, S0_y1=180, S0_x2=180, S0_y2=180 *) R #(.R(100k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_120_180, n_180_180 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=120, S0_y1=280, S0_x2=180, S0_y2=280 *) R #(.R(10k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_120_280, n_180_280 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=190, S0_y1=330, S0_x2=250, S0_y2=330 *) R #(.R(500),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_190_330, n_250_330 );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=190, S0_y1=140, S0_x2=250, S0_y2=140 *) C #(.C(1.5n),.V(),.Symbol(neutral)) C1 ( n_190_140, n_250_140 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=270, S0_y1=140, S0_x2=330, S0_y2=140 *) R #(.R(100k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_270_140, n_330_140 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=350, S0_y1=140, S0_x2=410, S0_y2=140 *) L #(.L(80u),.I()) L1 ( n_350_140, n_410_140 );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=280, S0_y1=330, S0_x2=340, S0_y2=330 *) C #(.C(100n),.V(),.Symbol(neutral)) C2 ( n_280_330, n_340_330 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=420, S0_y1=230 *) GND #() \\*  ( n_420_230 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=420, S0_y1=170, S0_x2=420, S0_y2=230 *) Vdc #(.U(12 V)) V1 ( n_420_170, n_420_230 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=120, S0_y1=330 *) GND #() \\*  ( n_120_330 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=190, S0_y1=330 *) GND #() \\*  ( n_190_330 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=280, S0_y1=330 *) GND #() \\*  ( n_280_330 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=120, S0_y1=180, S0_x2=180, S0_y2=180 *) R #(.R(100k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_120_180, n_180_180 );
