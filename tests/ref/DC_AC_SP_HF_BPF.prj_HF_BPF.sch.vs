module HF_BPF();
    ...
    wire n_800_220;
    wire n_800_90;
    (* x=550, y=90 *) INDQ INDQ1(n_520_90,n_580_90);
    (* x=630, y=170 *) INDQ INDQ3(n_630_200,n_630_140);
    (* x=590, y=170 *) CAPQ CAPQ3(n_590_200,n_590_140);
    (* x=800, y=220 *) GND *(n_800_220);
    (* x=800, y=170 *) Pac P1(n_800_140,n_800_200);
    (* x=310, y=170 *) INDQ INDQ2(n_310_200,n_310_140);
    (* x=410, y=90 *) CAPQ CAPQ1(n_380_90,n_440_90);
    (* x=270, y=170 *) CAPQ CAPQ2(n_270_200,n_270_140);
    (* x=310, y=220 *) GND *(n_310_220);
    (* x=20, y=310 *) .DC DC1();
    (* x=450, y=320 *) Eqn Eqn2();
    (* x=450, y=440 *) Eqn Eqn1();
    (* x=230, y=310 *) .SP SP1();
    (* x=20, y=410 *) .AC AC1();
    (* x=100, y=220 *) GND *(n_100_220);
    (* x=100, y=150 *) Pac P2(n_100_120,n_100_180);
    (* x=630, y=290 *) GND *(n_630_290);
    (* x=630, y=250 *) Vdc V1(n_630_220,n_630_280);
