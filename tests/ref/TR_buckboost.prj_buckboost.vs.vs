(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="buckboost.dat", qucs_DataDisplay="buckboost.dpl", qucs_SimOpenDpl=1, qucs_Script="buckboost.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module buckboost();
    ...
    wire n_640_190;
    wire n_640_240;
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=130, S0_y1=260, S0_x2=190, S0_y2=260 *) Vrect #(.U(1V),.TH(Ton),.TL(Toff),.Tr(1 ns),.Tf(1 ns),.Td(0 ns)) V2 ( n_130_260, n_190_260 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=130, S0_y1=360 *) GND #() \\*  ( n_130_360 );
    (* qucs_mirrored=0, qucs_rotated=2, S0_x1=50, S0_y1=160, S0_x2=110, S0_y2=160 *) Vdc #(.U(12V)) V1 ( n_50_160, n_110_160 );
    ...
    (* qucs_mirrored=0, qucs_rotated=3, S0_x1=540, S0_y1=160, S0_x2=540, S0_y2=220 *) C #(.C(100u),.V(0),.Symbol(neutral)) C1 ( n_540_160, n_540_220 );
