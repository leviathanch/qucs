(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=883, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="selective_amp.dat", qucs_DataDisplay="selective_amp.dpl", qucs_SimOpenDpl=1, qucs_Script="selective_amp.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module selective_amp();
    ...
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=120, S0_y1=180, S0_x2=120, S0_y2=120 *) R #(.R(100k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_120_180, n_120_120 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=120, S0_y1=280, S0_x2=120, S0_y2=220 *) R #(.R(10k),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_120_280, n_120_220 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=190, S0_y1=330, S0_x2=190, S0_y2=270 *) R #(.R(500),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_190_330, n_190_270 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=40, S0_y1=20 *) \.DC  #(.Temp(26.85),.reltol(0.001),.abstol(1 pA),.vntol(1 uV),.saveOPs(no),.MaxIter(150),.saveAll(no),.convHelper(none),.Solver(CroutLU)) DC1 (  );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=370, S0_y1=280 *) \.AC  #(.Type(log),.Start(300 kHz),.Stop(800 kHz),.Points(100),.Noise(no)) AC1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=500, S0_y1=200 *) Eqn #(.Gain(dB(Output.v/Input.v)),.Export(yes)) Eqn1 (  );
    ...
    (* S0_x1=440, S0_y1=60, S0_x2=353, S0_y2=140, qucs_type="Text", S0_text="Classical design of selective voltage amplifier:\n- common-emitter circuit\n- bias control with voltage divider R1, R2\n- bias stabilisation with negative current\n  feedback R3\n- use C2 to prevent R3 from decreasing gain\n- filtering with high Q resonance C1/L1/R4 load", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0 *) S0_text #() S0_text1;
endmodule
