(* qucs_ViewX1=-34, qucs_ViewY1=-194, qucs_ViewX2=740, qucs_ViewY2=559, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=177, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="fet_noise.dat", qucs_DataDisplay="fet_noise.dpl", qucs_SimOpenDpl=1, qucs_Script="fet_noise.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module fet_noise();
    ...
    (* S0_x=260, S0_y=50, qucs_type="Text", S0_text="For a description of the FET noise\nmodel take a look into its subcircuit.", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=269, qucs_h=40 *) S0_text #() S0_text1();
    (* S0_x=30, S0_y=260, qucs_type="Text", S0_text="This amplifier is noise matched at the input\nfor a frequency of 10GHz.\nThus, the noise optimum Sopt of the overall\ncircuit is zero. (Okay, the matching circuit\nis really ugly, but hey, this is a simulation.)", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=328, qucs_h=100 *) S0_text #() S0_text2();
endmodule
