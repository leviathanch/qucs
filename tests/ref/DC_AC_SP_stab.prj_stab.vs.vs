(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="stab.dat", qucs_DataDisplay="stab.dpl", qucs_SimOpenDpl=1, qucs_Script="stab.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module stab();
    ...
    (* S0_x=140, S0_y=0, qucs_type="Text", S0_text="bias stabilisation" *) S0_text #() S0_text2;
    (* S0_x1=390, S0_y1=200, S0_x2=-20, S0_y2=-60, qucs_type="Arrow", qucs_xp1=-21, qucs_yp1=-39, qucs_xp2=-7, qucs_yp2=-44,  *) S0_text #() S0_text3;
    (* S0_x=240, S0_y=0, qucs_type="Text", S0_text="Circuits of this kind are used tonstabilize the bias of RFntransistors. But sometimes theyntend to LF oscillations. Thisnschematic shows how tondetermine the degree of stabilitynby simulating magnitude andnphase margin of the loop gain.nResult: As a rule of thumb,nit should be  C2 >> C1" *) S0_text #() S0_text4;
    (* S0_x=200, S0_y=0, qucs_type="Text", S0_text="for measuringnthe loop stability" *) S0_text #() S0_text5;
endmodule
