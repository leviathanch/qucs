(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="stab.dat", qucs_DataDisplay="stab.dpl", qucs_SimOpenDpl=1, qucs_Script="stab.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module stab();
    ...
    (* S0_x=60, S0_y=20, qucs_type="Rectangle", qucs_w=230, qucs_h=190 *) S0_graphics #() S0_graphics1();
    (* S0_x=70, S0_y=140, qucs_type="Text", S0_text="bias stabilisation", qucs_font_color="#00007f", qucs_font_size=14, qucs_font_angle=90, qucs_w=118, qucs_h=19 *) S0_text #() S0_text1();
    (* S0_x=390, S0_y=200, qucs_type="Arrow", qucs_pen_color="#ff0000", qucs_pen_width=3, qucs_pen_style=1, qucs_w=-20, qucs_h=-60 *) S0_graphics #() S0_graphics2();
    (* S0_x=20, S0_y=240, qucs_type="Text", S0_text="Circuits of this kind are used tonstabilize the bias of RFntransistors. But sometimes theyntend to LF oscillations. Thisnschematic shows how tondetermine the degree of stabilitynby simulating magnitude andnphase margin of the loop gain.nResult: As a rule of thumb,nit should be  C2 >> C1", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=228, qucs_h=181 *) S0_text #() S0_text2();
    (* S0_x=360, S0_y=200, qucs_type="Text", S0_text="for measuringnthe loop stability", qucs_font_color="#ff0000", qucs_font_size=12, qucs_font_angle=0, qucs_w=115, qucs_h=37 *) S0_text #() S0_text3();
endmodule
