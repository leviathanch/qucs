...
<Components>
  ...
  <OpAmp OP1 1 230 190 -26 -82 1 0 "1e6" 1 "15 V" 0>
  ...
  <OpAmp OP2 1 440 170 -26 -82 1 0 "1e6" 1 "15 V" 0>
  ...
  <OpAmp OP3 1 650 150 -26 -82 1 0 "1e6" 1 "15 V" 0>
  <C C6 1 610 240 17 -26 0 1 "1n" 1 "" 0 "neutral" 0>
  <GND * 5 610 270 0 0 0 0>
  <C C3 1 580 60 -26 17 0 0 "256n" 1 "" 0 "neutral" 0>
  <.AC AC1 1 460 290 0 33 0 0 "log" 1 "1 Hz" 1 "10 kHz" 1 "201" 1 "no" 0>
  <Eqn Eqn1 1 300 330 -33 17 0 0 "y=1" 1 "yes" 0>
  <.DC DC1 1 100 360 0 33 0 0 "26.85" 0 "0.001" 0 "1 pA" 0 "1 uV" 0 "no" 0 "150" 0 "no" 0 "none" 0 "CroutLU" 0>
</Components>
<Wires>
...
<Paintings>
  <Text 220 410 12 #000000 0 "6th order Chebyshev I low-pass filtern1kHz band stop frequency, 1dB ripple">
</Paintings>
