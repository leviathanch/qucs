...
module sawtooth-2();
    ...
    (* S0_x1=120, S0_y1=320, S0_x2=180, S0_y2=320 *) R #(.R(100 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_120_320, n_180_320 );
    (* S0_x1=120, S0_y1=230, S0_x2=180, S0_y2=230 *) R #(.R(120 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_120_230, n_180_230 );
    (* S0_x1=440, S0_y1=60, S0_x2=500, S0_y2=60 *) C #(.C(1 pF),.V(),.Symbol(neutral)) C1 ( n_440_60, n_500_60 );
    (* S0_x1=260, S0_y1=130, S0_x2=320, S0_y2=130 *) R #(.R(43 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_260_130, n_320_130 );
    (* S0_x1=880, S0_y1=190, S0_x2=880, S0_y2=150, S0_x3=950, S0_y3=170 *) OpAmp #(.G(1e6),.Umax(15 V)) OP3 ( n_880_190, n_880_150, n_950_170 );
    (* S0_x1=890, S0_y1=270, S0_x2=950, S0_y2=270 *) R #(.R(100 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_890_270, n_950_270 );
    (* S0_x1=640, S0_y1=250, S0_x2=640, S0_y2=310 *) Vdc #(.U(0.6 V)) V2 ( n_640_250, n_640_310 );
    (* S0_x1=640, S0_y1=340 *) GND #() \*  ( n_640_340 );
    (* S0_x1=660, S0_y1=220, S0_x2=720, S0_y2=220 *) R #(.R(100 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R5 ( n_660_220, n_720_220 );
    (* S0_x1=820, S0_y1=340 *) GND #() \*  ( n_820_340 );
    (* S0_x1=820, S0_y1=260, S0_x2=820, S0_y2=200 *) R #(.R(47.4 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R6 ( n_820_260, n_820_200 );
    (* S0_x1=660, S0_y1=150, S0_x2=720, S0_y2=150 *) R #(.R(924 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R7 ( n_660_150, n_720_150 );
    ...
    (* S0_x1=950, S0_y1=170, S0_x2=970, S0_y2=170 *) net #() OUT ( n_950_170, n_970_170 );
    (* S0_x1=970, S0_y1=170, S0_x2=970, S0_y2=270 *) net #() net26 ( n_970_170, n_970_270 );
    (* S0_x1=950, S0_y1=270, S0_x2=970, S0_y2=270 *) net #() net27 ( n_950_270, n_970_270 );
    (* S0_x1=550, S0_y1=150, S0_x2=660, S0_y2=150 *) net #() net28 ( n_550_150, n_660_150 );
    (* S0_x1=750, S0_y1=150, S0_x2=750, S0_y2=220 *) net #() net29 ( n_750_150, n_750_220 );
    (* S0_x1=720, S0_y1=220, S0_x2=750, S0_y2=220 *) net #() net30 ( n_720_220, n_750_220 );
    (* S0_x1=720, S0_y1=150, S0_x2=750, S0_y2=150 *) net #() net31 ( n_720_150, n_750_150 );
    (* S0_x1=640, S0_y1=310, S0_x2=640, S0_y2=340 *) net #() net32 ( n_640_310, n_640_340 );
    (* S0_x1=640, S0_y1=220, S0_x2=640, S0_y2=250 *) net #() net33 ( n_640_220, n_640_250 );
    (* S0_x1=640, S0_y1=220, S0_x2=660, S0_y2=220 *) net #() net34 ( n_640_220, n_660_220 );
    (* S0_x1=750, S0_y1=150, S0_x2=820, S0_y2=150 *) net #() net35 ( n_750_150, n_820_150 );
    (* S0_x1=820, S0_y1=150, S0_x2=880, S0_y2=150 *) net #() net36 ( n_820_150, n_880_150 );
    (* S0_x1=820, S0_y1=150, S0_x2=820, S0_y2=200 *) net #() net37 ( n_820_150, n_820_200 );
    (* S0_x1=820, S0_y1=260, S0_x2=820, S0_y2=340 *) net #() net38 ( n_820_260, n_820_340 );
endmodule
