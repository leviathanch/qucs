module sawtooth-2();
    ...
    (* S0_x1=440, S0_y1=60, S0_x2=500, S0_y2=60 *) C #(.C(1 pF),.V()) C1 ( n_440_60, n_500_60 );
    ...
    (* S0_x1=300, S0_y1=350 *) \.TR  #(.Type(lin),.Start(0),.Stop(10u),.Points(1001),.IntegrationMethod(Gear),.Order(1),.InitialStep(1 ns),.MinStep(1e-16),.MaxIter(150),.reltol(0.01),.abstol(100 pA),.vntol(100 uV),.Temp(26.85),.LTEreltol(1e-2),.LTEabstol(1e-5),.LTEfactor(1),.Solver(CroutLU),.relaxTSR(yes),.initialDC(no),.MaxStep(0)) TR1 (  );
