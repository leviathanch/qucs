module stab();
    ...
    (* S0_x1=470, S0_y1=120, S0_x2=470, S0_y2=60 *) R #(.R(20 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_470_120, n_470_60 );
    (* S0_x1=340, S0_y1=120, S0_x2=400, S0_y2=120 *) Vac #(.U(1 V),.f(1 GHz),.Phase(0),.Theta(0)) V2 ( n_340_120, n_400_120 );
    (* S0_x1=170, S0_y1=90, S0_x2=170, S0_y2=30 *) Diode #(.Is(1e-15 A),.N(1),.Cj0(10 pF),.M(0.5),.Vj(0.7 V),.Fc(0.5),.Cp(0.0 fF),.Isr(0.0),.Nr(2.0),.Rs(0.0 Ohm),.Tt(0.0 ps),.Ikf(26.85),.Kf(0.0),.Af(1.0),.Ffe(0),.Bv(0),.Ibv(1 mA),.Temp(26.85),.Xti(3.0),.Eg(1.11),.Tbv(0.0),.Trs(0.0),.Ttt1(0.0),.Ttt2(0.0),.Tm1(0.0),.Tm2(0.0),.Tnom(26.85),.Area(1.0)) D2 ( n_170_90, n_170_30 );
    (* S0_x1=170, S0_y1=150, S0_x2=170, S0_y2=90 *) Diode #(.Is(1e-15 A),.N(1),.Cj0(10 pF),.M(0.5),.Vj(0.7 V),.Fc(0.5),.Cp(0.0 fF),.Isr(0.0),.Nr(2.0),.Rs(0.0 Ohm),.Tt(0.0 ps),.Ikf(26.85),.Kf(0.0),.Af(1.0),.Ffe(0),.Bv(0),.Ibv(1 mA),.Temp(26.85),.Xti(3.0),.Eg(1.11),.Tbv(0.0),.Trs(0.0),.Ttt1(0.0),.Ttt2(0.0),.Tm1(0.0),.Tm2(0.0),.Tnom(26.85),.Area(1.0)) D1 ( n_170_150, n_170_90 );
    ...
    (* S0_x1=160, S0_y1=400, S0_x2=220, S0_y2=400 *) C #(.C(1 nF),.V()) C4 ( n_160_400, n_220_400 );
    (* S0_x1=470, S0_y1=460 *) GND #() \*  ( n_470_460 );
    (* S0_x1=650, S0_y1=460 *) GND #() \*  ( n_650_460 );
    (* S0_x1=610, S0_y1=270 *) GND #() \*  ( n_610_270 );
    (* S0_x1=550, S0_y1=360, S0_x2=610, S0_y2=360 *) C #(.C(1 nF),.V()) C3 ( n_550_360, n_610_360 );
    ...
    (* S0_x1=220, S0_y1=340, S0_x2=220, S0_y2=280 *) R #(.R(10 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R3 ( n_220_340, n_220_280 );
    (* S0_x1=170, S0_y1=210 *) GND #() \*  ( n_170_210 );
    (* S0_x1=170, S0_y1=210, S0_x2=170, S0_y2=150 *) R #(.R(20 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_170_210, n_170_150 );
    (* S0_x1=550, S0_y1=140 *) Eqn #(.LoopGain(output.v / input.v),.LoopPhase(phase(output.v / input.v))) Eqn1 (  );
    ...
    (* S0_x1=550, S0_y1=270, S0_x2=610, S0_y2=270 *) C #(.C(0.1 uF),.V()) C1 ( n_550_270, n_610_270 );
    (* S0_x1=300, S0_y1=270, S0_x2=360, S0_y2=270 *) C #(.C(5 uF),.V()) C2 ( n_300_270, n_360_270 );
