module gyrator();
    ...
    (* S0_x1=570, S0_y1=320, S0_x2=570, S0_y2=260 *) R #(.R(1000 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) Load ( n_570_320, n_570_260 );
    ...
    (* S0_x1=280, S0_y1=160, S0_x2=340, S0_y2=160 *) R #(.R(20 kOhm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_280_160, n_340_160 );
    (* S0_x1=380, S0_y1=160, S0_x2=440, S0_y2=160 *) C #(.C(200 uF),.V()) C1 ( n_380_160, n_440_160 );
