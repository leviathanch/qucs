(* qucs_ViewX1=0, qucs_ViewY1=-18, qucs_ViewX2=860, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=30, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="preregulator.dat", qucs_DataDisplay="preregulator.dpl", qucs_SimOpenDpl=0, qucs_Script="preregulator.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module preregulator();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=490, S0_y1=170 *) \.SW  #(.Sim(DC1),.Type(lin),.Start(VBAT),.Stop(4),.Points(14),.Points(101)) SW1 (  );
    ...
    (* S0_x1=110, S0_y1=100, S0_x2=230, S0_y2=100 *) net #() in ( n_110_100, n_230_100 );
    (* S0_x1=360, S0_y1=100, S0_x2=360, S0_y2=170 *) net #() net1 ( n_360_100, n_360_170 );
    (* S0_x1=290, S0_y1=100, S0_x2=360, S0_y2=100 *) net #() out ( n_290_100, n_360_100 );
    ...
    (* S0_x=90, S0_y=20, qucs_type="Text", S0_text="Simple series regulator circuit.", qucs_font_color="#000000", qucs_font_size=16, qucs_font_angle=0, qucs_w=227, qucs_h=25 *) S0_text #() S0_text1();
endmodule
