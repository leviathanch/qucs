module test_circuit();
    ...
    (* S0_x1=280, S0_y1=200S0_x2=220, S0_y2=200 *) Sub #(.File(short_circuit.sch)) SC1 ( n_280_200, n_220_200 );
    ...
    (* S0_x1=140, S0_y1=200S0_x2=220, S0_y2=200 *) net #() in ( n_140_200, n_220_200 );
    (* S0_x1=340, S0_y1=200S0_x2=340, S0_y2=220 *) net #() net6 ( n_340_200, n_340_220 );
    (* S0_x1=280, S0_y1=200S0_x2=340, S0_y2=200 *) net #() net7 ( n_280_200, n_340_200 );
endmodule
