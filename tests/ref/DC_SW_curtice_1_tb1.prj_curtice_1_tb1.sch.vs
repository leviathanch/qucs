module curtice_1_tb1();
    ...
    wire n_80_130;
    wire n_80_190;
    (* x=80, y=160 *) Vdc V2(n_80_130,n_80_190);
    (* x=80, y=190 *) GND *(n_80_190);
    (* x=40, y=250 *) .DC DC1();
    (* x=70, y=390 *) Eqn Eqn1();
    (* x=380, y=220 *) .SW SW1();
    (* x=540, y=220 *) .SW SW2();
    (* x=380, y=160 *) GND *(n_380_160);
    (* x=380, y=120 *) Vdc V1(n_380_90,n_380_150);
    (* x=210, y=160 *) GND *(n_210_160);
    (* x=320, y=60 *) IProbe Pr1(n_350_60,n_290_60);
    (* x=210, y=120 *) Sub Curtice1(n_210_160,n_180_120,n_210_80);
