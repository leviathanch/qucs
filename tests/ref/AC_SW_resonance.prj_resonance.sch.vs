module resonance();
    ...
    wire n_440_70;
    wire n_440_200;
    (* S0_x1=120, S0_y1=120S0_x2=120, S0_y2=180 *) Vac #(.U(1 V),.f(1 GHz),.Phase(0),.Theta(0)) V1 ( n_120_120, n_120_180 );
    (* S0_x1=320, S0_y1=240 *) GND #() \*  ( n_320_240 );
    (* S0_x1=120, S0_y1=240 *) GND #() \*  ( n_120_240 );
    (* S0_x1=320, S0_y1=120S0_x2=320, S0_y2=60 *) R #(.R(R_par),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85),.Symbol(european)) R1 ( n_320_120, n_320_60 );
    (* S0_x1=320, S0_y1=240S0_x2=320, S0_y2=180 *) C #(.C(2 pF),.V(),.Symbol(neutral)) C1 ( n_320_240, n_320_180 );
