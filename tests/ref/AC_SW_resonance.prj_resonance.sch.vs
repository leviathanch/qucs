...
module resonance();
    ...
    (* S0_x1=320, S0_y1=120, S0_x2=320, S0_y2=60 *) R #(.R(R_par),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_320_120, n_320_60 );
