...
<Components>
  ...
  <R R1 1 290 260 -26 15 0 0 "0 Ohm" 1 "26.85" 0 "0.0" 0 "0.0" 0 "26.85" 0 "european" 0>
...
<Paintings>
  <Text 190 60 12 #000000 0 "simple subcircuit which justnshorts the two ports">
  <Text 140 430 12 #000000 0 "C1 is used just to have ancomponent in the subcircuit netlistn(does not change the simulation/netlisting results)">
</Paintings>
