...
<Paintings>
  <Text 60 0 12 #000000 0 "simple subcircuit which justnshorts the two ports">
  <Text 430 0 12 #000000 0 "C1 is used just to have ancomponent in the subcircuit netlistn(does not change the simulation/netlisting results)">
</Paintings>
