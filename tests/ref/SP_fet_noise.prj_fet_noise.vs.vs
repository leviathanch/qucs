(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="fet_noise.dat", qucs_DataDisplay="fet_noise.dpl", qucs_SimOpenDpl=1, qucs_Script="fet_noise.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module fet_noise();
    ...
    (* S0_x=260, S0_y=50, qucs_type="Text", S0_text="For a description of the FET noisenmodel take a look into its subcircuit.", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=253, qucs_h=37 *) S0_text #() S0_text1();
    (* S0_x=30, S0_y=260, qucs_type="Text", S0_text="This amplifier is noise matched at the inputnfor a frequency of 10GHz.nThus, the noise optimum Sopt of the overallncircuit is zero. (Okay, the matching circuitnis really ugly, but hey, this is a simulation.)", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=309, qucs_h=91 *) S0_text #() S0_text2();
endmodule
