(* qucs_ViewX1=-10, qucs_ViewY1=-14, qucs_ViewX2=1075, qucs_ViewY2=849, qucs_Scale=0.9631, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="curtice_1_tb1.dat", qucs_DataDisplay="curtice_1_tb1.dpl", qucs_SimOpenDpl=0, qucs_Script="curtice_1_tb1.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module curtice_1_tb1();
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=380, S0_y1=220 *) \.SW  #(.Sim(DC1),.Type(lin),.Start(R1),.Stop(Vds),.Points(-10),.Points(41)) SW1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=540, S0_y1=220 *) \.SW  #(.Sim(SW1),.Type(lin),.Start(R1),.Stop(Vgs),.Points(-5),.Points(6)) SW2 (  );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, qucs_type="Sub", qucs_File="curtice_1.sch", S0_x1=210, S0_y1=160, S0_x2=180, S0_y2=120, S0_x3=210, S0_y3=80 *) curtice_1 #(.RG(0),.RD(0),.RS(0),.VBR(10e10),.LG(1e-15),.LD(1e-15),.LS(1e-15),.IS(10f),.N(1),.XTI(0),.EG(1.11),.Beta(3m),.Lambda(40m),.VT0(-6),.Temp(27),.Alpha(0.8),.CDS(300f),.TAU(10p),.RIN(1m),.CGS(300f),.CGD(300f),.Tnom(27)) Curtice ( n_210_160, n_180_120, n_210_80 );
