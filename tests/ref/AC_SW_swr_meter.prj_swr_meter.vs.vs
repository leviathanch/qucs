(* qucs_ViewX1=0, qucs_ViewY1=0, qucs_ViewX2=800, qucs_ViewY2=800, qucs_Scale=1, qucs_tmpViewX1=-200, qucs_tmpViewY1=-200, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="swr_meter.dat", qucs_DataDisplay="swr_meter.dpl", qucs_SimOpenDpl=1, qucs_Script="swr_meter.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module swr_meter();
    ...
    wire n_440_120;
    wire n_440_240;
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=380, S0_y1=180 *) GND #() \*  ( n_380_180 );
    (* qucs_mirrored=0, qucs_rotated=2, qucs_visible="", S0_x1=320, S0_y1=240 *) GND #() \*  ( n_320_240 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=260, S0_y1=380, S0_x2=260, S0_y2=320 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_260_380, n_260_320 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="100000", S0_x1=440, S0_y1=380, S0_x2=440, S0_y2=320 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_440_380, n_440_320 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=440, S0_y1=380 *) GND #() \*  ( n_440_380 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=260, S0_y1=380 *) GND #() \*  ( n_260_380 );
    (* qucs_mirrored=1, qucs_rotated=0, qucs_visible="100000", S0_x1=140, S0_y1=120, S0_x2=200, S0_y2=120 *) R #(.R(50 Ohm),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R4 ( n_140_120, n_200_120 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=140, S0_y1=220 *) GND #() \*  ( n_140_220 );
    (* qucs_mirrored=0, qucs_rotated=0, qucs_visible="", S0_x1=620, S0_y1=220 *) GND #() \*  ( n_620_220 );
    (* qucs_mirrored=0, qucs_rotated=1, qucs_visible="1000", S0_x1=140, S0_y1=160, S0_x2=140, S0_y2=220 *) Vac #(.U(2 V),.f(1 GHz),.Phase(0),.Theta(0)) V1 ( n_140_160, n_140_220 );
    (* qucs_mirrored=1, qucs_rotated=3, qucs_visible="1", S0_x1=320, S0_y1=240, S0_x2=320, S0_y2=300, S0_x3=380, S0_y3=300, S0_x4=380, S0_y4=240 *) Tr #(.T(25)) Tr2 ( n_320_240, n_320_300, n_380_300, n_380_240 );
