...
module timer_Discharge(.P_control_in(n_255_150), .P_GND(n_260_260), .P_Discharge(n_260_320));
    ...
    wire n_500_120;
    wire n_500_320;
    (* S0_x1=320, S0_y1=150, S0_x2=380, S0_y2=150 *) R #(.R(10K),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R1 ( n_320_150, n_380_150 );
    ...
    (* S0_x1=340, S0_y1=320, S0_x2=400, S0_y2=320 *) R #(.R(200),.Temp(26.85),.Tc1(0.0),.Tc2(0.0),.Tnom(26.85)) R2 ( n_340_320, n_400_320 );
