(* qucs_ViewX1=0, qucs_ViewY1=10, qucs_ViewX2=800, qucs_ViewY2=760, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="fullwaverectifier_1.dat", qucs_DataDisplay="fullwaverectifier_1.dpl", qucs_SimOpenDpl=0, qucs_Script="fullwaverectifier_1.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module fullwaverectifier_1();
    wire n_290_110;
    wire n_350_150;
    wire n_350_210;
    wire n_290_250;
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=80, S0_y1=350 *) Eqn #(.Veff(220),.Vamp(Veff*sqrt(2)),.Vfreq(50),.Tperiod(1/Vfreq),.Tmax(2*Tperiod),.Export(yes)) Eqn1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=200, S0_y1=340 *) \.TR  #(.Type(lin),.Start(0),.Stop(Tmax),.Points(201),.IntegrationMethod(Trapezoidal),.Order(2),.InitialStep(1 ns),.MinStep(1e-16),.MaxIter(150),.reltol(0.001),.abstol(1 pA),.vntol(1 uV),.Temp(26.85),.LTEreltol(1e-3),.LTEabstol(1e-6),.LTEfactor(1),.Solver(CroutLU),.relaxTSR(no),.initialDC(yes),.MaxStep(0)) TR1 (  );
    ...
    (* S0_x1=50, S0_y1=110, S0_x2=130, S0_y2=110 *) net #() out ( n_50_110, n_130_110 );
    (* S0_x1=50, S0_y1=110, S0_x2=50, S0_y2=150 *) net #() net6 ( n_50_110, n_50_150 );
    (* S0_x1=290, S0_y1=170, S0_x2=290, S0_y2=180 *) net #() net7 ( n_290_170, n_290_180 );
    (* S0_x1=290, S0_y1=180, S0_x2=290, S0_y2=190 *) net #() net8 ( n_290_180, n_290_190 );
    (* S0_x1=110, S0_y1=180, S0_x2=290, S0_y2=180 *) net #() net9 ( n_110_180, n_290_180 );
    (* S0_x1=110, S0_y1=180, S0_x2=110, S0_y2=250 *) net #() net10 ( n_110_180, n_110_250 );
    (* S0_x1=50, S0_y1=250, S0_x2=110, S0_y2=250 *) net #() net11 ( n_50_250, n_110_250 );
    (* S0_x1=50, S0_y1=210, S0_x2=50, S0_y2=250 *) net #() net12 ( n_50_210, n_50_250 );
    (* S0_x1=430, S0_y1=110, S0_x2=430, S0_y2=150 *) net #() net13 ( n_430_110, n_430_150 );
    (* S0_x1=350, S0_y1=110, S0_x2=430, S0_y2=110 *) net #() in ( n_350_110, n_430_110 );
    (* S0_x1=350, S0_y1=110, S0_x2=350, S0_y2=150 *) net #() net14 ( n_350_110, n_350_150 );
    ...
    (* S0_x1=50, S0_y1=30, S0_x2=368, S0_y2=19, qucs_type="Text", S0_text="Full-wave rectifier using a transformer and 2 diodes.", qucs_font_color="#000000", qucs_font_size=16, qucs_font_angle=0 *) S0_text #() S0_text1;
endmodule
