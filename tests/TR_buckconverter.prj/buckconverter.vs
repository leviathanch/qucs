(* qucs_ViewX1=0, qucs_ViewY1=10, qucs_ViewX2=1366, qucs_ViewY2=861, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="buckconverter.dat", qucs_DataDisplay="buckconverter.dpl", qucs_SimOpenDpl=0, qucs_Script="buckconverter.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module buckconverter();
    ...
    (* S0_x1=50, S0_y1=30, S0_x2=158, S0_y2=19, qucs_type="Text", S0_text="Buck converter circuit.", qucs_font_color="#000000", qucs_font_size=16, qucs_font_angle=0 *) S0_text #() S0_text1;
    (* S0_x1=50, S0_y1=70, S0_x2=526, S0_y2=19, qucs_type="Text", S0_text="Change duty cycle (\"Bduty\" in the equations) to manipulate output voltage.", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0 *) S0_text #() S0_text2;
endmodule
