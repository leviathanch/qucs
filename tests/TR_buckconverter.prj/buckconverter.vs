(* qucs_ViewX1=0, qucs_ViewY1=10, qucs_ViewX2=1366, qucs_ViewY2=861, qucs_Scale=1, qucs_tmpViewX1=0, qucs_tmpViewY1=0, qucs_GridX=10, qucs_GridY=10, qucs_GridOn=1, qucs_DataSet="buckconverter.dat", qucs_DataDisplay="buckconverter.dpl", qucs_SimOpenDpl=0, qucs_Script="buckconverter.m", qucs_SimRunScript=0, qucs_showFrame=0, qucs_FrameText0="Title", qucs_FrameText1="Drawn By:", qucs_FrameText2="Date:", qucs_FrameText3="Revision:" *) module buckconverter();
    ...
    wire n_540_140;
    wire n_540_240;
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=130, S0_y1=260, S0_x2=130, S0_y2=320 *) Vrect #(.U(1V),.TH(Ton),.TL(Toff),.Tr(1 ns),.Tf(1 ns),.Td(0 ns)) V2 ( n_130_260, n_130_320 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=130, S0_y1=360 *) GND #() \*  ( n_130_360 );
    (* qucs_mirrored=0, qucs_rotated=1, S0_x1=50, S0_y1=160, S0_x2=50, S0_y2=220 *) Vdc #(.U(12V)) V1 ( n_50_160, n_50_220 );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=50, S0_y1=240 *) GND #() \*  ( n_50_240 );
    ...
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=350, S0_y1=290 *) Eqn #(.Tmax(Bperiod*20),.Tstep(Bperiod/1000),.Export(yes)) Eqn2 (  );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=490, S0_y1=280 *) \.TR  #(.Type(lin),.Start(0),.Stop(Tmax),.Points(201),.IntegrationMethod(Trapezoidal),.Order(2),.InitialStep(1 ns),.MinStep(Tstep),.MaxIter(150),.reltol(0.001),.abstol(1 pA),.vntol(1 uV),.Temp(26.85),.LTEreltol(1e-3),.LTEabstol(1e-6),.LTEfactor(1),.Solver(CroutLU),.relaxTSR(no),.initialDC(yes),.MaxStep(Tstep)) TR1 (  );
    (* qucs_mirrored=0, qucs_rotated=0, S0_x1=530, S0_y1=510 *) Eqn #(.Bfreq(40k),.Bperiod(1/Bfreq),.Bduty(50),.Ton(Bperiod*Bduty/100),.Toff(Bperiod-Ton),.Export(yes)) Eqn1 (  );
    ...
    (* S0_x=50, S0_y=30, qucs_type="Text", S0_text="Buck converter circuit.", qucs_font_color="#000000", qucs_font_size=16, qucs_font_angle=0, qucs_w=157, qucs_h=24 *) S0_text #() S0_text1();
    (* S0_x=50, S0_y=70, qucs_type="Text", S0_text="Change duty cycle (\"Bduty\" in the equations) to manipulate output voltage.", qucs_font_color="#000000", qucs_font_size=12, qucs_font_angle=0, qucs_w=525, qucs_h=24 *) S0_text #() S0_text2();
endmodule
