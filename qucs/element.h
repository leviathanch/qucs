...
public:
  ...
  virtual void set_cx(int i) {_cx=i;}
  virtual void set_cy(int i) {_cy=i;}
  virtual void set_x1(int i) {_x1=i;}
  virtual void set_y1(int i) {_y1=i;}
  virtual void set_x2(int i) {_x2=i;}
  virtual void set_y2(int i) {_y2=i;}

private:
  int  _cx{0}, _cy{0}, _x1{0}, _y1{0}, _x2{0}, _y2{0};  // center and relative boundings
